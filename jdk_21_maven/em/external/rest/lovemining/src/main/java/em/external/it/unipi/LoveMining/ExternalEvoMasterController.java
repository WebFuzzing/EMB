package em.external.it.unipi.LoveMining;
...
public class ExternalEvoMasterController extends ExternalSutController {
    ...
    public static void main(String[] args) {
        ...
        String jarLocation = "cs/rest/lovemining/target";
        if (args.length > 2) {
            jarLocation = args[2];
        }
        if (!jarLocation.endsWith(".jar")) {
            jarLocation += "/lovemining-sut.jar";
        }
    ...
    public ExternalEvoMasterController() {
        this(DEFAULT_CONTROLLER_PORT, "../target/lovemining-sut.jar", DEFAULT_SUT_PORT, 120, "java");
    }
    ...
    public String getLogMessageOfInitializedServer() {
        return "Started LoveMiningApplication in ";
    }
