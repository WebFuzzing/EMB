package em.external.org.graphqlscs;
...
public class ExternalEvoMasterController extends ExternalSutController {
    ...
    public static void main(String[] args) {
        ...
        String jarLocation = "cs/graphql/graphql-scs/target";
        if (args.length > 2) {
            jarLocation = args[2];
        }
        if(! jarLocation.endsWith(".jar")) {
            jarLocation += "/graphql-scs-sut.jar";
        }
