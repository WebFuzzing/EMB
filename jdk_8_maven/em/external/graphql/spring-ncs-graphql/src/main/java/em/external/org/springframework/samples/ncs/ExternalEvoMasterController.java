package em.external.org.springframework.samples.ncs;
...
public class ExternalEvoMasterController extends ExternalSutController {
    ...
    public static void main(String[] args) {
        ...
        String jarLocation = "cs/graphql/spring-ncs-graphql/target";
        if (args.length > 2) {
            jarLocation = args[2];
        }
        if(! jarLocation.endsWith(".jar")) {
            jarLocation += "/ncs-sut.jar";
        }
    ...
    public String getPackagePrefixesToCover() {
        return "org.springframework.samples.ncs";
    }
