using AutoMapper;
using CaseStudies.Rest.Library.Authentication;
using CaseStudies.Rest.Library.Contexts;
using CaseStudies.Rest.Library.OperationFilters;
using CaseStudies.Rest.Library.Services;
                 ...
                 IApiVersionDescriptionProvider apiVersionDescriptionProvider)
        {
            ...
            app.UseSwaggerUI(setupAction =>
            {
                ...
                setupAction.IndexStream = ()
                        => GetType().Assembly
                        .GetManifestResourceStream("CaseStudies.Rest.Library.EmbeddedAssets.index.html");
